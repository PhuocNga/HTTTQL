...
<body class="nav-md">
    <div class="container body">
		...
		<%List<Object[]>listCompare1=(ArrayList)session.getAttribute("stackchart1");
		List<Object[]>listCompare2=(ArrayList)session.getAttribute("stackchart2");
		List<String>listMonthYear=(ArrayList)session.getAttribute("quarter_year");
		%>
                ...
                <div class="">
                    ...
                    <div class="x-panel">
                        ...
                        <c:set var="listQuarter" value="${sessionScope.quarter}"/>
                         <form action="<c:url value="/thongke/soasanhdoanhthuquy"/>">
                        <div class="x_content">
                       <div style="font-size: 17px;color: #008B8B;">Điều kiện so sánh 1</div>
                            ...
                            <div class="btn-group">
                                ...
                                <select class="form-control" id="sel1" name="quartercompare1">
                            ...
                            <div style="font-size: 17px;color: #008B8B;">Điều kiện so sánh 2</div>
                             ...
                             <div class="btn-group">
                                <p><strong>Chọn quý</strong></p>
                                <select class="form-control" id="sel1" name="quartercompare2">
                                <c:forEach items="${listQuarter}" var="quarter" >
                                <option value="${quarter}"><c:out value="${quarter}"/></option>
                                </c:forEach>
                              </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Doanh thu trong quý <c:out value="${sessionScope.quarter_year.get(0)}"/>/<c:out value="${sessionScope.quarter_year.get(1)}"/>
                                        và trong quý <c:out value="${sessionScope.quarter_year.get(2)}"/>/<c:out value="${sessionScope.quarter_year.get(3)}"/> của từng sản phẩm
                                        </h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
