...
<title>Doanh thu theo quý</title>
	    <!-- Bootstrap -->
...
Object[]thongketong=(Object[])session.getAttribute("thongketong_theoquy");
                ...
                <div class="">
                    ...
                    <div class="x-panel">
                        ...
                        <c:set var="listQuarter" value="${sessionScope.quarter}"/>
                         <form action="<c:url value="/thongke/thongketheoquy"/>">
                        <div class="x_content">
                            <div class="btn-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Doanh thu thu được ở từng sản phẩm trong quý: <c:out value="${sessionScope.quarterRequest }"/> >> năm <c:out value="${sessionScope.yearRequest }"/></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                            <li class="dropdown">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Số lượng bán được của từng sản phẩm trong quý: <c:out value="${sessionScope.quarterRequest }"/> >> năm <c:out value="${sessionScope.yearRequest }"/></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                            <li class="dropdown">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Biểu đồ dạng table mô tả doanh thu thu được trong quý: <c:out value="${sessionScope.quarterRequest }"/> >> năm <c:out value="${sessionScope.yearRequest }"/></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                            <li class="dropdown">
                                    ...
                                    <div class="x_content">
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            <thead>
                                            <tr><div style="text-align: center; font-size: 25px">Chi tiết bán hàng của từng sản phẩm trong quý <c:out value="${sessionScope.quarterRequest}"/> năm <c:out value="${sessionScope.yearRequest}"/></div></tr>
                                                <tr>
                                                    <th>Tên sản phẩm</th>
