...
<title>Thống kê nhân viên theo tháng</title>
	    <!-- Bootstrap -->
...
<body class="nav-md">
<%List<Object[]>listObject=(List<Object[]>)session.getAttribute("chart_thongke_theothang");
        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <div class="">
                    ...
                    <div class="x-panel">
                        <div class="x_title">
                            <h2>Thống kê doanh thu bán hàng của nhân viên theo tháng</h2>
                        ...
                        <c:set var="listMonth" value="${sessionScope.month}"/>
                         <form action="<c:url value="/thongke/thongkenhanvientheothang"/>">
                        <div class="x_content">
                            <div class="btn-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Doanh thu bán hàng của từng nhân viên trong tháng <c:out value="${sessionScope.monthRequest}"/> >> năm <c:out value="${sessionScope.yearRequest}"/></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                            <li class="dropdown">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Số lượng bán được của từng nhân viên trong tháng <c:out value="${sessionScope.monthRequest}"/> >> năm <c:out value="${sessionScope.yearRequest}"/></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                            <li class="dropdown">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Biểu đồ dạng table mô tả doanh thu bán hàng của nhân viên trong tháng <c:out value="${sessionScope.monthRequest}"/> >> năm <c:out value="${sessionScope.yearRequest}"/></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                            <li class="dropdown">
                                    ...
                                    <div class="x_content">
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            <thead>
                                             <tr><div style="text-align: center; font-size: 25px">Chi tiết bán hàng của từng nhân viên trong tháng <c:out value="${sessionScope.monthRequest}"/> năm <c:out value="${sessionScope.yearRequest}"/></div></tr>
                                                <tr>
                                                    <th>Tên sản phẩm</th>
